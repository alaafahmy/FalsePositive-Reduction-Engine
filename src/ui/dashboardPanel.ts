...
import { FinalResult, Alert } from '../types';

export class DashboardPanel {
  public static currentPanel: DashboardPanel | undefined;
  public static readonly viewType = 'zerofalseDashboard';
  ...
  private _selectedAlert?: FinalResult;

  public static createOrShow(
    extensionUri: vscode.Uri,
    results: FinalResult[],
    selectedAlert?: FinalResult
  ) {
  ...
  public updateData(results: FinalResult[], selectedAlert?: FinalResult) {
    this._results = results;
    if (selectedAlert) {
      this._selectedAlert = selectedAlert;
    }
  ...
  public get currentSelectedAlert(): FinalResult | undefined {
